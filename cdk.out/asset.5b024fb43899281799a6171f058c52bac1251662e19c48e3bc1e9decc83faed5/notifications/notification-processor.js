...
var require_data_stream = __commonJS({
  "node_modules/web-push/node_modules/jws/lib/data-stream.js"(exports2, module2) {
...
var require_jwa = __commonJS({
  "node_modules/web-push/node_modules/jwa/index.js"(exports2, module2) {
    var Buffer2 = require_safe_buffer().Buffer;
...
var require_tostring = __commonJS({
  "node_modules/web-push/node_modules/jws/lib/tostring.js"(exports2, module2) {
    var Buffer2 = require("buffer").Buffer;
...
var require_sign_stream = __commonJS({
  "node_modules/web-push/node_modules/jws/lib/sign-stream.js"(exports2, module2) {
    var Buffer2 = require_safe_buffer().Buffer;
...
var require_verify_stream = __commonJS({
  "node_modules/web-push/node_modules/jws/lib/verify-stream.js"(exports2, module2) {
    var Buffer2 = require_safe_buffer().Buffer;
    var DataStream = require_data_stream();
    var jwa = require_jwa();
    var Stream = require("stream");
...
var require_jws = __commonJS({
  "node_modules/web-push/node_modules/jws/index.js"(exports2) {
...
var notification_processor_exports = {};
__export(notification_processor_exports, {
  handler: () => handler
});
module.exports = __toCommonJS(notification_processor_exports);
...
var NOTIFICATIONS_TABLE = process.env.NOTIFICATIONS_TABLE;
var CONNECTIONS_TABLE = process.env.CONNECTIONS_TABLE;
var PUSH_SUBSCRIPTIONS_TABLE = process.env.PUSH_SUBSCRIPTIONS_TABLE;
var WS_ENDPOINT = process.env.WEBSOCKET_API_ENDPOINT;
var SECRETS_NAME = process.env.SECRETS_NAME;
...
async function sendWebSocketNotification(userId, notification) {
  ...
  try {
    ...
    const apiClient = new import_client_apigatewaymanagementapi.ApiGatewayManagementApiClient({
...
async function sendPushNotification(userId, notification) {
  try {
    ...
    const vapidPublicKey = secrets.NEXT_PUBLIC_VAPID_PUBLIC_KEY || secrets.VAPID_PUBLIC_KEY;
    ...
    const webpush = await Promise.resolve().then(() => __toESM(require_src2()));
...
function getNotificationUrl(type, relatedId) {
  switch (type) {
    case "message":
      return relatedId ? `/dashboard/messaging/${relatedId}` : "/dashboard/messaging";
    case "appointment":
      return "/dashboard/appointments";
    case "payment":
      return "/dashboard/payment";
    case "profile_visit":
      return relatedId ? `/dashboard/profile/${relatedId}` : "/dashboard/profile-visits";
    case "video_call":
      return relatedId ? `/dashboard/video-session/${relatedId}` : "/dashboard/video-session";
    default:
